...
const registerUser = asyncHandler(async (req, res) => {
  try {
    ...
    // Step 3: Store details temporarily in session
    ...
    const transporter = nodemailer.createTransport({
      service: "gmail",
      auth: {
        user: "kasammapara13@gmail.com", // Replace with your Gmail
        pass: process.env.GMAIL_APP_PASSWORD,    // Use Gmail App Password or SMTP credentials
      },
    });
...
const verifyOtp = asyncHandler(async (req, res) => {
  ...
  if (parseInt(otp) !== req.session.tempUser.otp) {
...
const sendForgetOtp = async (req, res) => {
  try {
    ...
    const otp = Math.floor(100000 + Math.random() * 900000);
    console.log("Reset OTP:", otp); // Debug
    ...
    const transporter = nodemailer.createTransport({
      service: "gmail",
      auth: {
        user: "kasammapara13@gmail.com",
        pass: process.env.GMAIL_APP_PASSWORD, // App password
      },
    });

    const mailOptions = {
      from: '"SoundShare Support" <kasammapara13@gmail.com>',
      to: email,
...
const mediapage = asyncHandler(async (req, res) => {
    try {
        ...
        const moodUrls = {
            A: `https://firebasestorage.googleapis.com/v0/b/alumini8-3fd16.appspot.com/o/my-storage%2FMain%20agar%20kahoon.mp3?alt=media&token=7b5fff8d-8cca-4702-8c14-d62d85c1c25b`,
            B: `https://firebasestorage.googleapis.com/v0/b/alumini8-3fd16.appspot.com/o/my-storage%2FTera%20yaar%20hoon%20mai.mp3?alt=media&token=be61d93b-14f4-4d51-a909-101cfa2b5a20`,
            C: `https://firebasestorage.googleapis.com/v0/b/alumini8-3fd16.appspot.com/o/my-storage%2FTere%20jaisa%20yaar%20kaha.mp3?alt=media&token=f6f745fb-b40a-4f19-8ba2-487fd5d28f80`,
            D: `https://firebasestorage.googleapis.com/v0/b/alumini8-3fd16.appspot.com/o/my-storage%2FTu%20hai%20toh.mp3?alt=media&token=658a6e88-d3fc-403e-9672-fb967c3a1fed`,
            E: `https://firebasestorage.googleapis.com/v0/b/alumini8-3fd16.appspot.com/o/my-storage%2FTu%20hi%20yaar%20mera.mp3?alt=media&token=a51ae28b-6462-4f01-bf9d-1e8069ceec05`,
            F: `https://firebasestorage.googleapis.com/v0/b/alumini8-3fd16.appspot.com/o/my-storage%2Fold%20song%20mashup.mp3?alt=media&token=f751cf76-11af-4cf7-a587-8fa987da5834`,
            G: `https://firebasestorage.googleapis.com/v0/b/alumini8-3fd16.appspot.com/o/my-storage%2Fthousand%20years.mp3?alt=media&token=614aed54-0b1f-49ee-b9b9-0744dd18bc37`,
            H: `https://firebasestorage.googleapis.com/v0/b/alumini8-3fd16.appspot.com/o/my-storage%2Ftumse%20mil%20ke.mp3?alt=media&token=c6f6389c-4c8a-42a8-8b3c-3f5bddf03e90`,
            DEFAULT: `https://firebasestorage.googleapis.com/v0/b/alumini8-3fd16.appspot.com/o/my-storage%2Fzara%20zara.mp3?alt=media&token=5f312d51-48bb-437a-8938-e4718f44c404`
        };
